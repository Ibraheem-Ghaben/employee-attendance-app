...
async function createEmployeeUsers() {
    try {
        ...
        const mssPool = await (0, database_1.getConnection)();
        ...
        for (const employee of employees) {
            try {
                ...
                const existingUser = await localPool
                    .request()
                    .input('username', localDatabase_1.sql.VarChar, employeeCode)
                ...
                await localPool
                    ...
                    .input('role', localDatabase_1.sql.VarChar, 'employee')
                    .input('full_name', localDatabase_1.sql.NVarChar, fullName)
                    .input('email', localDatabase_1.sql.VarChar, `${employeeCode.toLowerCase()}@mss.com`)
                    .query(`
