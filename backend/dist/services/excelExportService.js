...
class ExcelExportService {
    constructor() {
        this.employeeProfileService = new employeeProfileService_1.EmployeeProfileService();
    }
    /**
     * Export attendance data to Excel
     */
    async exportAttendanceToExcel(employeeCode, startDate, endDate) {
        try {
            // Use the unified service to get data
            const data = await this.employeeProfileService.getAttendanceForExport(employeeCode, startDate, endDate);
