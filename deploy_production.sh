...
# 🚀 Employee Attendance System - Production Deployment Script
# Version: 3.0.0
...
print_status "Phase 7: Configuring Nginx..."
...
# Phase 7.5: Install SSL Certificate (Optional)
print_status "Phase 7.5: Installing SSL certificate for MSS-HR.com..."
...
if ping -c 1 MSS-HR.com &> /dev/null; then
    ...
    print_warning "Domain MSS-HR.com is not accessible. SSL certificate installation skipped."
    echo "   Please ensure DNS is pointing to this server before installing SSL"
fi

# Phase 8: Start Production Services
print_status "Phase 8: Starting production services..."
...
print_status "Phase 9: Setting up log rotation..."
...
print_status "Phase 10: Running final checks..."
...
echo "   Frontend: http://MSS-HR.com"
echo "   Backend API: http://MSS-HR.com/api"
echo ""
...
echo "   3. Update database passwords in .env file"
echo "   4. Change JWT secret in .env file"
